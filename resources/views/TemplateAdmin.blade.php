                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('accruedList') }}">Devengado</a></li>
                            <li><a class="dropdown-item" href="{{ route('discountList') }}">Descuento</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('departmentList') }}">Listado</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button"
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="{{ route('employeeList') }}">Listado</a></li>
                            <li><a class="dropdown-item" href="{{ route('payrollPartial') }}">Nomina parcial</a></li>
                            <li><a class="dropdown-item" href="{{ route('employeePayroll') }}">Nomina</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
